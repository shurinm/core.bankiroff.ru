...
class SubDomainHelper
{
	...
	public static function getSubdomainNameGenitive($subdomain)
    {
        if ($subdomain) {
            $subdomain_obj = Region::where('subdomain', $subdomain)->first();
            if (!$subdomain_obj) return null;
            $subdomain_region_name = $subdomain_obj->genitive;
            return $subdomain_region_name;
        }
        return null;
    }

    public static function getSubdomainNameDative($subdomain)
    {
        if ($subdomain) {
            $subdomain_obj = Region::where('subdomain', $subdomain)->first();
            if (!$subdomain_obj) return null;
            $subdomain_region_name = $subdomain_obj->dative;
            return $subdomain_region_name;
        }
        return null;
    }

    public static function getSubdomainNamePrepositional($subdomain)
    {
        if ($subdomain) {
            $subdomain_obj = Region::where('subdomain', $subdomain)->first();
            if (!$subdomain_obj) return null;
            $subdomain_region_name = $subdomain_obj->prepositional;
            return $subdomain_region_name;
        }
        return null;
    }

    public static function getSubdomainName($subdomain)
    {
        if ($subdomain) {
            $subdomain_obj = Region::where('subdomain', $subdomain)->first();
            if (!$subdomain_obj) return null;
            $subdomain_region_name = $subdomain_obj->name;
            return $subdomain_region_name;
        }
        return null;
    }
